...
function Profile() {
  ...
  const [profileImage, setProfileImage] = useState(
    imageName
      ? `https://arogyaai-backend-dic1.onrender.com/profile-image/${imageName}`
  ...
  const uploadProfileImage = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://arogyaai-backend-dic1.onrender.com/upload-profile-image",
      ...
      if (data.success) {
        ...
        setProfileImage(
          `https://arogyaai-backend-dic1.onrender.com/profile-image/${data.image}?t=${Date.now()}`,
        );
  ...
  const saveProfile = async () => {
    try {
      const response = await fetch(
        "https://arogyaai-backend-dic1.onrender.com/update-profile",
